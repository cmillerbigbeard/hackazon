...
RUN apt-get update
RUN DEBIAN_FRONTEND=noninteractive apt-get -y install nano default-mysql-client default-mysql-server apache2 php5.6 libapache2-mod-php5.6 pwgen python-setuptools vim-tiny php5.6-mysql php5.6-gd php5.6-ldap supervisor unzip
